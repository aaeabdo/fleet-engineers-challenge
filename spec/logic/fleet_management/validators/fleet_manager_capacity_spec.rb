...
RSpec.describe Logic::FleetManagement::Validators::FleetManagerCapacity do
  subject(:call) { described_class.call(capacity) }

  context 'invalid' do
    let(:error_message) do
      'Fleet manager capacity must be an integer'\
    ...
    shared_examples_for 'invalid' do
      it 'raises invalid fleet manager capacity error' do
        expect { call }.to raise_error(
          Logic::FleetManagement::Validators::InvalidFleetManagerCapacityError,
          error_message
        )
      end
    end
